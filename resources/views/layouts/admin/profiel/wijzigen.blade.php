...
@section('content')
            ...
            <div class="row justify-content-center">
                <div class="col-md-11">
                    <div class="float-right">
                        {{-- knop dat terug gaat naar de profiel pagina --}}
                        <a class="createbutton createbuttonSupportedContent" href="{{ route('AProfiel.profiel') }}">Terug</a>
                    </div>
                </div>
            </div>
    ...
    @endif
        ...
        {{-- slaat de nieuwe gegevens van de ingelogde gebruiker op --}}
        <form action="{{ route('AProfiel.wijziging_opslaan',$user->id) }}"  enctype="multipart/form-data" method="POST">
        @csrf
        @method('PATCH')
        ...
        <div class="row justify-content-center">
            <div class="col-sm-5">
                ...
                {{--   toont de woord "Tussenvoegsel" en de Voornaam van de gebruiker  --}}
                <div class="row justify-content-center">
                    <div class="col-8 col-sm-5">
            ...
            <div class="col-sm-5">
                ...
                {{--   toont de woord "Logo" en de Logo van de gebruiker  --}}
                <div class="row justify-content-center">
                    <div class="col-8 col-sm-5">
                        <strong>Logo:</strong>
                    </div>
