...
{{--                        </br>--}}
                        ...
                        <div class="row justify-content-center">
                            <form action="{{ route('AProfiel.destroy',$user->id) }}" method="POST">
                                ...
                                <a class="createbutton createbuttonSupportedContent" href="{{ route('AProfiel.edit',$user->id) }}">Aanpassen</a>

                                @csrf
                                @method('DELETE')
                                <br>
{{--                                <a class="createbutton createbuttontarief createbuttonSupportedContent" href="{{ route('BProfieltarief.create',$tarief->id) }}">Uurtarief wijzigen</a>--}}
